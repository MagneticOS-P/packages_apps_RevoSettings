...
import com.revo.settings.preferences.SystemSettingSwitchPreference;
import com.revo.settings.preferences.SystemSettingSeekBarPreference;
...
public class ClockDateSettings extends SettingsPreferenceFragment implements
    ...
    private SystemSettingSeekBarPreference mHideDuration;
    private SystemSettingSeekBarPreference mShowDuration;

    @Override
    public void onCreate(Bundle icicle) {
        super.onCreate(icicle);
        addPreferencesFromResource(R.xml.revo_settings_clock);
	...
	// clock settings
        ...
        mHideDuration = (SystemSettingSeekBarPreference) findPreference(CLOCK_DATE_AUTO_HIDE_HDUR);
        ...
        mShowDuration = (SystemSettingSeekBarPreference) findPreference(CLOCK_DATE_AUTO_HIDE_SDUR);
        ...
        int clockDateStyle = Settings.System.getInt(resolver,
                Settings.System.STATUSBAR_CLOCK_DATE_STYLE, 14);
